...
jQuery(document).ready(function($){
  ...
  $('#main-menu-min').click(function(){
    ...
    if($(this).hasClass('full')){
      ...
      $(this).removeClass('full').addClass('minified').find('i').removeClass('icon-double-angle-left').addClass('icon-double-angle-right');
      ...
      $(this).removeClass('minified').addClass('full').find('i').removeClass('icon-double-angle-right').addClass('icon-double-angle-left');
...
jQuery(document).ready(function($){
  ...
  if($(".todo-list").length) {
    ...
    $(".todo-actions > a").click(function(){
      ...
      if ($(this).find('i').attr('class') == 'icon-ok done') {
